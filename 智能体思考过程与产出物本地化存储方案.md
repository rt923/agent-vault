...
>
> **当前实际落地架构**请参见 [[審計追蹤層架構設計]]（v2.1，已通过 ArchQ 评审）。
>
...
v1.0  TRAE 交付标准作业程序
       └── _design/trae-delivery-sop.md（交付流程标准化）
```
...
- [[審計追蹤層架構設計]] — 当前实际落地架构（v2.1）
- [[審計追蹤層設計評審_ArchQ]] — ArchQ 架构治理评审全文
- [[_design/trae-delivery-sop]] — TRAE 交付标准作业程序
...
**变更记录**
- 2026-07-21：v2.1 与交付 SOP 对齐——新增 [[_design/trae-delivery-sop]] 引用，演进脉络补全 SOP 链，版本号同步
